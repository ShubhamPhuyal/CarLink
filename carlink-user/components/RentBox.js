...
import RentalModal from "./rentform/RentalModal";
...
export default function RentBox({ _id, title, description, price, images, properties }) {
  const url = "/rent/" + _id;
      ...
      <ProductWrapper>
        ...
        <ProductInfoBox>
          ...
          <PriceRow>
            ...
            <RentNowButton onClick={() => setShowModal(true)}>
              Rent Now
            </RentNowButton>
          </PriceRow>
        </ProductInfoBox>
