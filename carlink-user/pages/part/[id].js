...
import { FaTools, FaCogs, FaCalendarAlt, FaWeight, FaTint, FaBoxOpen, FaCube, FaLeaf, FaIndustry, FaComments } from "react-icons/fa";
...
const iconMap = {
  Type: <FaTools style={{ color: iconColor }} />,
  Compatibility: <FaCogs style={{ color: iconColor }} />,
  Weight: <FaWeight style={{ color: iconColor }} />,
  Color: <FaTint style={{ color: iconColor }} />,
  Dimensions: <FaBoxOpen style={{ color: iconColor }} />,
  Material: <FaCube style={{ color: iconColor }} />,
  Year: <FaCalendarAlt style={{ color: iconColor }} />,
  Manufacturer: <FaIndustry style={{ color: iconColor }} />,
  Condition: <FaLeaf style={{ color: iconColor }} />,
};

export default function PartPage({ product }) {
  const selectedProperties = [
    "Type", "Compatibility", "Weight", "Color", "Dimensions", "Material", "Year", "Manufacturer", "Condition"
  ];
