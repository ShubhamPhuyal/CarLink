...
const Container = styled.div`
  ...
  padding: 0 1rem; /* Add padding to avoid edges */
`;
...
const Grid = styled.div`
  ...
  @media (min-width: 1024px) {
    grid-template-columns: 1fr 1fr; /* Two columns for medium screens and larger */
  }
`;
...
const Title = styled.h2`
  ...
  @media (min-width: 1024px) {
    font-size: 2.25rem; /* Larger title for bigger screens */
  }
...
const Description = styled.div`
  ...
  -webkit-line-clamp: 4; /* Limit lines for the description */
  overflow: hidden;
  line-height: 1.6;
`;
