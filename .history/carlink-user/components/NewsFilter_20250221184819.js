...
export default function FilterSection({ products, setFilteredProducts }) {
  ...
  const filterProducts = () => {
    ...
    if (searchTerm) {
      ...
      filtered = products; // Reset to show all products if search term is empty
    }
  ...
  const handleToggleType = (type) => {
    ...
    filterProducts(); // Filter products whenever a type is toggled
  };
  ...
  const handleToggleBrand = (brand) => {
    ...
    filterProducts(); // Filter products whenever a brand is toggled
  };
