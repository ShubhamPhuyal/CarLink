...
const FilterContainer = styled.div`
  display: flex;
  justify-content: ${props => (props.show ? 'flex-start' : 'flex-end')};
  align-items: center;
  padding: 20px;
  ...
  flex-wrap: wrap;
  gap: 20px;
  min-height: 100px; /* Set a minimum height to prevent movement */
  transition: min-height 0.2s ease; /* Optional: Smooth transition for height */
`;
