...
export default function NewsFeatured({ products, setFilteredProducts }) { // Add products and setFilteredProducts as props
  return (
    <Section>
      <MeshBackground />
      ...
      <Center>
        <ContentWrapper>
          ...
          <SearchBar products={products} setFilteredProducts={setFilteredProducts} /> {/* Add SearchBar component */}
