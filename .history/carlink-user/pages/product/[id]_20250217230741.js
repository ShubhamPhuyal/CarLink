...
export default function ProductPage({ product }) {
  const selectedProperties = [
    "Fuel", "Fuel", "Miles", "Color", "Door", "Cylinder", "EngineSize", "Year", "Model", "Condition"
  ];
        ...
        <ColWrapper>
          ...
          <RightColumnWrapper>
            ...
            <SpecificationsBox>
              ...
              {product.properties && Object.entries(product.properties)
                .filter(([key]) => selectedProperties.map(property => property.trim()).includes(key.trim())) // Trim both key and selectedProperties
                .map(([key, value]) => (
                  <SpecRow key={key}>
