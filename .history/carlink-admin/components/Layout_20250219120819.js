...
export default function Layout({ children }) {
    ...
    if (!session) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <div className="w-full max-w-5xl bg-white rounded-2xl shadow-xl overflow-hidden flex p-4">
                    {/* Login Form Section */}
    ...
    return (
        <div className="bg-white min-h-screen flex ">
            <Nav />
            <div className="bg-white rounded-2xl flex-grow mt-2 mr-2 mb-2 rounded-lg p-4" style={{ backgroundColor: '#F6F7FA' }}>
                {children}
            </div>
        </div>
    );
