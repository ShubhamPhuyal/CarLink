...
export default function Layout({ children }) {
    ...
    useEffect(() => {
        ...
        // Add mouse hover effect for clickable elements
        ...
        const handleMouseUp = () => setCursorVariant("button");
        
        // Add mouse hover effect for input elements
    ...
    // Apply cursor styles based on variant
    useEffect(() => {
        // Apply cursor styles when DOM is ready
        ...
        if (document.readyState === 'complete') {
            ...
            return () => window.removeEventListener('DOMContentLoaded', applyEventListeners);
        }
    }, [isRegistering]); // Re-apply when registration form toggles
