...
export default function Layout({ children }) {
    ...
    if (!session) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center pt-4 pb-4 pr-4">
                <div className="w-full max-w-5xl bg-white rounded-3xl shadow-xl overflow-hidden flex p-4">
                    {/* Login Form Section */}
